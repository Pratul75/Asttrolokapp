...
@section('content')
    ...
    @if(!empty($heroSectionData))
        ...
        @if(!empty($heroSectionData['has_lottie']) and $heroSectionData['has_lottie'] == "1")
            @push('scripts_bottom')
                <script src="{{ config('app.js_css_url') }}/assets2/default/vendors/lottie/lottie-player.js"></script>
            @endpush
        @endif
       <div>
...
<div class="swiper-container slider-home-banner-section2">
    <div class="swiper-wrapper ">
        @foreach ($HomeSlider as $key=> $value)
            <div class="swiper-slide slider-height" style="background-image: url('{{ config('app.img_dynamic_url') }}{{ $value->hero_background }}') ;background-size: cover!important;
                                ...
                                @if($heroSection == "2")
                                    <div class="row slider-content align-items-center hero-section2 flex-column-reverse flex-md-row">
                                        ...
                                        <div class="col-12 col-md-5 col-lg-4 mobilehome " style="height: 382px;">
                                            ...
                                            <h2 class="text-secondary font-weight-bold  mobiledesc" style="font-size:16px;">{!! $value->title !!}</h2>
                                             <p class="slide-hint text-gray mt-10 mb-10 mobiledesc" style="font-size: 12.497px; line-height: 1.5;">{!! $value->description !!}{{--<br>
                                            ...
                                            @else
                                                <img src="{{ config('app.img_dynamic_url') }}{{ $value->hero_vector }}" alt="{{ $value->title }}" class="img-cover"style="max-height: 384px;max-width: 413px;">
                                            @endif
...
@endif
 ...
 @if($homeSection->name == \App\Models\HomeSection::$english_classes and !empty($englishclasses) and !$englishclasses->isEmpty())
        ...
        <!--                        <div class="swiper-slide">-->
        <!--                            @include('web.default2.includes.webinar.grid-card',['webinar' => $latestBundle])-->
        <!--                        </div>-->
        <!--                    @endforeach-->
                                            ...
                                            <figure>
                                                <div class="image-box news-box">
                                                    <a href="https://zeenews.india.com/lifestyle/homeandkitchen/vastu-tips-for-holi-2024-7-things-you-must-avoid-to-let-go-of-negative-energy-from-home-2733462.html" target="_blank">
                                                        <img src="{{ config('app.js_css_url') }}/assets/default/img/home/news/Zee_news.svg.png" class="img-cover" style="object-fit: contain; padding: 40px;"alt="img">
                                                    </a>
                                                </div>
                                            ...
                                            <figure>
                                                <div class="image-box news-box">
                                                    <a href="https://news.abplive.com/astro/vedic-science-vastu-shastra-in-improving-health-and-wellness-1680193" target="_blank">
                                                        <img src="{{ config('app.js_css_url') }}/assets/default/img/home/news/abp News-min.png" class="img-cover" style="object-fit: contain; padding: 40px;"alt="img">
                                                    </a>
                                                </div>
                                                <figcaption class="webinar-card-body">
                                                    <a href="https://news.abplive.com/astro/vedic-science-vastu-shastra-in-improving-health-and-wellness-1680193" target="_blank">
                                            ...
                                            <figure>
                                                <div class="image-box news-box">
                                                    <a href="https://timesofindia.indiatimes.com/astrology/vastu-feng-shui/from-enhancing-natural-light-to-creating-a-sacred-space-vastu-remedies-for-enhancing-positive-personality-traits/articleshow/109692065.cms" target="_blank">
                                                        <img src="{{ config('app.js_css_url') }}/assets/default/img/home/news/TOI-min.png" class="img-cover" style="object-fit: contain; padding: 40px;"alt="img">
                                                    </a>
                                                </div>
                                                <figcaption class="webinar-card-body">
                                                    <a href="https://timesofindia.indiatimes.com/astrology/vastu-feng-shui/from-enhancing-natural-light-to-creating-a-sacred-space-vastu-remedies-for-enhancing-positive-personality-traits/articleshow/109692065.cms" target="_blank">
                                            ...
                                            <figure>
                                                <div class="image-box news-box">
                                                    <a href="https://www.moneycontrol.com/news/technology/what-the-stars-foretell-lok-sabha-elections-are-boom-time-for-astrologers-12706862.html" target="_blank">
                                                        <img src="{{ config('app.js_css_url') }}/assets/default/img/home/news/Money Control-min.png" class="img-cover" style="object-fit: contain; padding: 40px;"alt="img">
                                                    </a>
                                                </div>
                                                <figcaption class="webinar-card-body">
                                                    <a href="https://www.moneycontrol.com/news/technology/what-the-stars-foretell-lok-sabha-elections-are-boom-time-for-astrologers-12706862.html" target="_blank">
                                            ...
                                            <figure>
                                                <div class="image-box news-box">
                                                    <a href="https://sugermint.com/alok-khandelwal/" target="_blank">
                                                        <img src="{{ config('app.js_css_url') }}/assets/default/img/home/news/sugar-mint.png" class="img-cover" style="object-fit: contain; padding: 40px;"alt="img">
                                                    </a>
                                                </div>
                                                <figcaption class="webinar-card-body">
                                                    <a href="https://sugermint.com/alok-khandelwal/" target="_blank">
                ...
                <div class="position-relative mt-20">
                    <div class="swiper-container organization-swiper-container px-12">
                        <div class="swiper-wrapper py-20">
                            ...
                            <!--                <p class="home-organizations-desc mt-10">{{ $organization->bio }}</p>-->
                                            <!--<span class="home-organizations-badge badge mt-15">{{ $organization->webinars_count }} {{ trans('panel.classes') }}</span>-->
                            <!--                <span class="home-organizations-badge badge mt-15">0 Remedies</span>-->
                            <!--            </a>-->
                            <!--        </div>-->
                            <!--    </div>-->
                            <!--@endforeach-->
                            ...
                            <div class="swiper-slide">
                                    <!--<div class="home-organizations-card d-flex flex-column align-items-center justify-content-center">-->
                                        ...
                                        <!--</div>-->
                                        <!--<a href="{{ $organization->getProfileUrl() }}" class="mt-25 d-flex flex-column align-items-center justify-content-center">-->
                                        <!--    <h3 class="home-organizations-title">{{ $remedy->title }}</h3>-->
                                            <!--<p class="home-organizations-desc mt-10">{{ $remedy->bio }}</p>-->
                                            <!--<span class="home-organizations-badge badge mt-15">{{ $remedy->webinars_count }} {{ trans('panel.classes') }}</span>-->
                                            <!--<span class="home-organizations-badge badge mt-15">0 Remedies</span>-->
                                        <!--</a>-->
                                    <!--</div>-->
                                </div>
