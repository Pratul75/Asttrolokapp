...
<section class="container forums-featured-section mt-30 mt-md-50">
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="forums-featured-card d-flex align-items-center bg-white p-20 p-md-35 rounded-lg mt-15">
                        <div class="forums-featured-card-icon">
                            <img src="/store/1/default_images/forums/icons/forum_music.svg" alt="How do you put a Group Link in a note card" class="img-cover">
                        </div>
                        <div class="ml-15">
                    ...
                    <div class="forums-featured-card d-flex align-items-center bg-white p-20 p-md-35 rounded-lg mt-15">
                        <div class="forums-featured-card-icon">
                            <img src="/store/1/default_images/forums/icons/forum_makeup.svg" alt="The best texture quality settings for makeup" class="img-cover">
                        </div>
                        <div class="ml-15">
                    ...
                    <div class="forums-featured-card d-flex align-items-center bg-white p-20 p-md-35 rounded-lg mt-15">
                        <div class="forums-featured-card-icon">
                            <img src="/store/1/default_images/forums/icons/food_forum.svg" alt="What favorite food and or beverage do you enjoy" class="img-cover">
                        </div>
                        <div class="ml-15">
                ...
                <div class="col-12 col-lg-6">
                    ...
                    <!--            <h4 class="font-16 font-weight-bold text-dark">How to Access a Quiz ?</h4>-->
                    <!--        </a>-->
                    <!--    </div>-->
                    <!--</div>-->
                </div>
