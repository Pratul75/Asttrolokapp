        ...
        <div class="col-md-8">
            ...
            <div class="">
               ...
               <div class="default-package-icon">
                <img src="{{ config('app.js_css_url') }}/assets/default/img/become-instructor/default.png" class="img-cover" alt="{{ trans('update.installment_overview') }}" width="176" height="144">
            </div>
