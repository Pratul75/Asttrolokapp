                    ...
                    <!--    </div>-->
                        <div class="pt-50  align-items-left align-items-start justify-content-between ">
                            <div class="d-flex frame-427322372-acu" id="1017:948">
                                ...
                                <img class="frame-427322370-8wF" src="{{ asset('assets/default/img/course/play-button.svg') }}" id="1017:938"/>
                                ...
                                <img class="frame-427322370-8wF" src="{{ asset('assets/default/img/course/green-video-icon (2).svg') }}" id="1017:939"/>
                                ...
                                <img class="frame-427322370-8wF" src="{{ asset('assets/default/img/course/ind-ruppes.svg') }}" id="864:10420"/>
...
<div class="row mt-lg-40 align-items-center font-14">
            <a href="https://www.youtube.com/@ASTTROLOKChannel?sub_confirmation=1" target="_blank" class="row m-0 col-6 p-5">
                ...
                <img src="https://asttrolok.in/assets/default/css/landingPage/resources/img/Icon/icon1/youtube-icon.png" width="50" height="50" alt="telegram" >
                </div>
                <span class="col-6 mt-5 d-block p-0"><b>188000</b> <br/>Subscribers</span>
            </a>

             <a href="https://www.facebook.com/Asttrolok/" target="_blank" class="row m-0 col-6 p-5">
                 <div class=" col-6 text-center ">
                <img src="https://asttrolok.in/assets/default/css/landingPage/resources/img/Icon/icon1/facebook-icon.png" width="50" height="50" alt="telegram">
                </div>
                <span class="col-6 mt-5 d-block p-0"><b>23918</b> <br/>Likes</span>
            </a>

             <a href="#" target="_blank" class="row m-0 mt-20 col-6 p-5">
                 <div class=" col-6 text-center ">
                <img src="https://asttrolok.in/assets/default/css/landingPage/resources/img/Icon/icon1/Happy-Customer.png" width="50" height="50" alt="telegram">
                </div>
             ...
             <a href="#" target="_blank" class="row m-0 mt-20 col-6 p-5">
                 <div class=" col-6 text-center ">
                <img src="https://asttrolok.in/assets/default/css/landingPage/resources/img/Icon/icon1/global-icon.png" width="50" height="50" alt="telegram">
                </div>
            ...
            <div class="col-12 col-lg-8">
                <div class="course-content-body mt-20 user-select-none">
                    <div class="course-body-on-cover text-white">
                        @if(url()->current()!='https://lms.asttrolok.com/course/learn-free-vedic-astrology-course-online')
