    ...
    <section class="container mt-0 mb-p bg-t">
        <div class="d-flex align-items-left align-items-start justify-content-between ">
            <div class="col-md-6 mt-20">
               <a href="/consult-with-astrologers" class="mt-10 back-button abcak"><img src="/assets/default/img/profile/left-arrow.svg" alt="left-arrow"  class="verify-img1 mr-5"> Back</a>
            </div>
                    ...
                    <div class=" ml-lg-40">
                        <h1 class="user-title font-weight-bold text-dark-blue">{{ $user["full_name"] }} @if($user->offline)
                            ...
                            <span class="user-circle-badge">
                                <img src="/assets/default/img/profile/verify-user.svg" alt="Verify User Icon - Asttrolok"  class="verify-img"></span>
                            @endif
