...
<div id="topFilters" class=" p-10 p-md-20 homehide1">
    ...
    <div class="row align-items-center">
        <div class="col-lg-12  align-items-center">
                        ...
                        <div class="shadow-lg border border-gray300 rounded-sm search-input bg-white p-10 flex-grow-1">
                            <form action="/search" method="get">
                                <div class="form-group d-flex align-items-center m-0">
                                    <!--<img width="25" height="25" src="https://img.icons8.com/sf-ultralight/25/000000/search.png" alt="search"/>-->
                                    <input type="text" name="search" class="form-control border-0 form-control1" placeholder="Search ..."/>
                                    <!--<button type="submit" class="btn btn-primary rounded-pill">{{ trans('home.find') }}</button>-->
                                   <img width="25" height="25" class="image-cover1" src="https://img.icons8.com/sf-ultralight/25/000000/search.png" alt="search"/>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <!--              <img width="20" height="20" src="https://img.icons8.com/color/48/menu-2.png" alt="menu-2"/> -->
            <!--            </div>-->
