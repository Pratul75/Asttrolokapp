...
<section class="mobile-home-slider mobilehome mob-ban site-top-banner search-top-banner opacity-04 position-relative hide-mobile">
        <img src="{{ config('app.img_dynamic_url') }}/store/1/about/Frame 427322271.jpg" class="banner-redius img-cover" alt="Instructors">

        <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        <!--<h1 class="text-white font-30 mb-15">Instructors </h1>-->
                ...
                <div class="row mx-5" style="transform: translate3d(0px, 0px, 0px); transition: all 0ms ease 0s;">
                    ...
                    <div class="d-flex col-6 col-md-12 col-lg-3 swiper-slide swiper-slide-active p-5" >
                        <div class="position-relative p-10 py-lg-30  px-lg-20 rounded-sm shadow bg-white text-center" style="width: 90%;">
                            <div class="d-flex align-items-center">
                                <div class="image-icon">
                                    <img src="{{ config('app.img_dynamic_url') }}/store/1/about/Consultation.svg" alt="Revathi Shridhar" class="img-cover  " />
                                </div>
                                <div class="ml-15">
                    ...
                    <div class="d-flex col-6 col-md-12 col-lg-3 swiper-slide swiper-slide-active p-5" >
                        <div class="position-relative p-10 py-lg-30  px-lg-20 rounded-sm shadow bg-white text-center" style="width: 90%;">
                            <div class="d-flex align-items-center">
                                <div class="image-icon">
                                    <img src="{{ config('app.img_dynamic_url') }}/store/1/about/Countries.svg" alt="Revathi Shridhar" class="img-cover  " />
                                </div>
                                <div class=" ml-15">
                    ...
                    <div class="d-flex col-6 col-md-12 col-lg-3 swiper-slide swiper-slide-active p-5" >
                        <div class="position-relative p-10 py-lg-30  px-lg-20 rounded-sm shadow bg-white text-center" style="width: 90%;">
                            <div class="d-flex align-items-center">
                                <div class="image-icon">
                                    <img src="{{ config('app.img_dynamic_url') }}/store/1/about/Pannel Astrologer.svg" alt="Revathi Shridhar" class="img-cover  " />
                                </div>
                                <div class=" ml-10">
