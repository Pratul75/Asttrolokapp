...
@section('content')
    <section class="site-top-banner search-top-banner opacity-04 position-relative">
        <img src="{{ config('app.img_dynamic_url') }}{{ $contactSettings['background'] }}" class="homehide img-cover" alt="{{ $pageTitle ?? 'contact' }}"/>
        ...
        <div class="container h-100 banner-contact ">
            ...
            <div class="pt-20 d-flex align-items-left align-items-start justify-content-between ">
                <div class="col-md-6 ">
                   <a href="/" class="back-button"><img src="/assets/default/img/profile/left-arrow.svg" alt="Left Arrow Icon - Asttrolok" class="verify-img1  back-button1 py-10 px-10"></a> <h1 class="ml-50 pt-5 text-white font-30 mb-15">Contact Us</h1>
                </div>
