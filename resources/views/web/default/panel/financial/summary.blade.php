                                ...
                                @foreach($amount_paid as $amount_paid1)
                                    <tr>
                                        ...
                                        <td class="text-center align-middle">
                                         ...
                                         <td class="text-left ">
                                               @if($amount_paid1[5] == 'part')
                                                <a href="/panel/webinars/{{ $amount_paid1[4] }}/part/{{ $amount_paid1[3] }}/invoice" target="_blank" title="{{ trans('admin/main.invoice') }}"><img src="https://storage.googleapis.com/astrolok/store/1/prints.png" width="25" alt="invoice-{{ $amount_paid1[2] }}"></a>
                                              
                                               @endif
                                                @if($amount_paid1[5] == 'course')
                                               
                                               <a href="/panel/webinars/{{ $amount_paid1[4] }}/sale/{{ $amount_paid1[3] }}/invoice" target="_blank" title="{{ trans('admin/main.invoice') }}"><img src="https://storage.googleapis.com/astrolok/store/1/prints.png" width="25" alt="invoice-{{ $amount_paid1[2] }}"></a>
                                               
                                               @endif
                                                @if($amount_paid1[5] == 'meeting')
                                                <a href="/panel/webinars/{{ $amount_paid1[4] }}/meeting/{{ $amount_paid1[3] }}/invoice" target="_blank" title="{{ trans('admin/main.invoice') }}"><img src="https://storage.googleapis.com/astrolok/store/1/prints.png" width="25" alt="invoice-{{ $amount_paid1[2] }}"></a>
